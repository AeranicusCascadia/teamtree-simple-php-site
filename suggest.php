...
// include for using array looping to auto populate drop down menu options
	...
	?>	
		...
		<form method="post" action="suggest.php">
			...
			<table>
				...
				<tr>
					<th><label for="details">Additional Details</th>
					<td><textarea name="details">Defalt Text</textarea></td>
				</tr>
